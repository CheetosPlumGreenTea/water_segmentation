...
if __name__ == "__main__":
    input_dir = 'data/res_imgs/'  # Directory containing images to predict
    output_dir = 'data/preprocessed/'  # Directory to save predictions
    ...
    input_dir = 'data/testing_dataset/image'  # Directory containing images to predict
    output_dir = 'data/testing_dataset/pre_image'  # Directory to save predictions
    os.makedirs(output_dir, exist_ok=True)
    image_files = [f for f in os.listdir(input_dir)]
    for image_path in image_files:
      processed = preprocess_for_water(os.path.join(input_dir, image_path))
